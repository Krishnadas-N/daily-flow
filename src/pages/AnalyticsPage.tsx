  ...
  return (
    <div className="h-full flex flex-col pt-4 md:pt-8 px-2 md:px-8 max-w-[1400px] mx-auto w-full animate-slide-up">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
        <div className="bg-white border border-slate-200 rounded-[28px] p-7 flex flex-col items-center shadow-sm hover:shadow-lg transition-shadow relative overflow-hidden group">
          <div className="absolute -top-6 -right-6 text-blue-500/10 group-hover:scale-110 transition-transform">
            <CheckCircle size={120} />
          </div>
          <p className="text-slate-500 text-sm font-bold uppercase tracking-wider mb-2 z-10 w-full text-left">
            Tasks Done
          </p>
          <div className="w-full flex items-end gap-3 z-10">
            ...
            <p className="text-blue-500/70 font-bold text-sm mb-1.5 leading-none">
              total
            </p>
          </div>
        </div>
        ...
        <div className="bg-white border border-slate-200 rounded-[28px] p-7 flex flex-col items-center shadow-sm hover:shadow-lg transition-shadow relative overflow-hidden group">
          ...
          <div className="w-full flex items-end gap-3 z-10">
            ...
            <p className="text-purple-500/70 font-bold text-sm mb-1.5 leading-none">
              topics
            </p>
          </div>
        </div>
        ...
        <div className="bg-white border border-slate-200 rounded-[28px] p-7 flex flex-col items-center shadow-sm hover:shadow-lg transition-shadow relative overflow-hidden group">
          ...
          <div className="w-full flex items-end gap-3 z-10">
            ...
            <p className="text-emerald-500/70 font-bold text-sm mb-1.5 leading-none">
              active
            </p>
          </div>
        </div>
        ...
        <div className="bg-white border border-slate-200 rounded-[28px] p-7 flex flex-col items-center shadow-sm hover:shadow-lg transition-shadow relative overflow-hidden group">
          ...
          <div className="w-full flex items-end gap-3 z-10">
            ...
            <p className="text-amber-500/70 font-bold text-sm mb-1.5 leading-none">
              total
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="bg-white border border-slate-200 rounded-[32px] p-8 shadow-sm hover:shadow-xl hover:shadow-slate-200/50 transition-shadow h-[420px] flex flex-col">
